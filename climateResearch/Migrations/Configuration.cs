namespace climateResearch.Migrations
{
    ...
    internal sealed class Configuration : DbMigrationsConfiguration<climateResearch.Models.ClimateDbContext>
    {
        ...
        protected override void Seed(climateResearch.Models.ClimateDbContext context)
        {
            //Пункты наблюдения
